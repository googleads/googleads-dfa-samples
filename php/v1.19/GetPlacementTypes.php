...
try {
  ...
  $result = $placementService->getPlacementTypes();
} catch (Exception $e) {
  print $e->getMessage();
  exit(1);
}
...
foreach($result as $placementType) {
  print 'Placement type with name "' . $placementType->name . '" and ID '
      . $placementType->id . " was found.\n";
}
